...
export const parse_annotation_data = (ann) => {
...
export const get_annotation_text = (ann) => parse_annotation_data(ann)[0]
export const get_annotation_data = (ann) => parse_annotation_data(ann)[1]

export const serialize_annotation_data = (ann_text, data) => (
