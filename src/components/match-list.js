...
export const MatchList = ({ matches }) => {
  ...
  const userIds = useMemo(() => usersFromMatches(matches), [matches]);
  ...
  return (
    <MatchListInternal isOpen={isOpen} onChange={onChange} matches={matches}>
...
export const MatchListInternal = ({
  ...
  return (
    ...
    >
      ...
      >
        <span>
          Wyniki meczy (<strong>{matches.length}</strong>)
        </span>
      </button>
    </Modal>
  );
                  ...
                  <Fragment key={id}>
                    ...
                    <td>
                      <button
                        ...
                        onClick={() =>
                          copyText(`${user.first_name} ${user.last_name}`)
                        }
                      >
...
const makeUserLink = (user) => (
  <a href={`/clients/c/${user.id}/`} target="blank">
            ...
            <td>
              <button
                ...
                onClick={async () => {
                  ...
                  show_success(
                    `Skopiowano dane użytkownika ${user.first_name} ${user.last_name}`
                  );
                }}
              >
                <GlyphIcon name="user" />
